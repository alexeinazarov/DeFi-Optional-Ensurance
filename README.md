...
| Mechanism                   | How downside is capped (human-speak)                                                                                                                                           | Can losses be *re-earned* if price bounces? |
|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|
...
### 5. Example for Today’s headline numbers (ETH ≈ \$2 555, 20 Jun 2025)
#### Optional-Ensurance during crash
| Quantity                                                    | Symbol / formula                                                  | Value |
|-------------------------------------------------------------|-------------------------------------------------------------------|-------|
| Up-front option cost                                        | $` X = \sum_i n_i P_i `$                                            |Theoretically, using [Black-Sholes formula](https://support.deribit.com/hc/en-us/articles/25944688327069-Inverse-Options) **\$ 3.5** per 0.8-ETH loan *(1 × 14-d 0.8 × S put + 0.25 × 7-d 0.9 × S put, σ₇d ≈ 79 %)*. <br>In practice ([derive.xyz](https://www.derive.xyz/options/eth?expiry=20250704)), at 2035 EDT ) **$22.0** per 0.8-ETH loan *(1 × 14-d put K ≈ $2 000, mid-price $17.1 + 0.25 × 7-d put K ≈ $2 200, mid-price $19.6).*|
| Daily theta bleed                                           | $` Y = -\frac{1}{365}\sum_i n_i \theta_i `$                         |Theoretically, using [Black-Sholes formula](https://support.deribit.com/hc/en-us/articles/25944688327069-Inverse-Options)  \$ 1.0 ≈ 0.05 %/day ≈ **18 % p.a.**. <br>In practice ([derive.xyz](https://www.derive.xyz/options/eth?expiry=20250704)), at 2035 EDT ) **$3.5 ≈ 0.17 % of loan per day ≈ 61 % p.a.** *(θ per contract: −$2.37 and −$4.60 ⇒ −$2.37 × 1 + −$4.60 × 0.25)*|
